...
public protocol DataSource: AnyObject {
    ...
    func imagePreviewer(_ previewer: Previewer, consoleForItemAtIndex index: Int) -> AccessoryView?
    
    /// 为每一个 Cell 提供自定义操作视图, 这个视图会覆盖在每个Cell的顶部
    func imagePreviewer(_ previewer: Previewer, accessoryViewForCell cell: CollectionViewCell, at index: Int) -> AccessoryView?
...
public extension DataSource {
    ...
    func imagePreviewer(_ previewer: Previewer, consoleForItemAtIndex index: Int) -> AccessoryView? { nil }
    
    func imagePreviewer(_ previewer: Previewer, accessoryViewForCell cell: CollectionViewCell, at index: Int) -> AccessoryView? { nil }
...
public extension Delegate {
    ...
    func imagePreviewer(_ previewer: Previewer, willDismissWithCell cell: CollectionViewCell, at index: Int) -> UIView? { nil }
    
    func imagePreviewerDidDismiss(_ previewer: Previewer) {}
    
    func imagePreviewer(_ previewer: Previewer, didLongPressAtIndex index: Int) {}
    
    func imagePreviewer(_ previewer: Previewer, shouldDismissWithGesture gesture: UIGestureRecognizer, at index: Int) -> Bool { true }
