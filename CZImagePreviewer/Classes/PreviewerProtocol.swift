...
public protocol ImagePreviewerDataSource: AnyObject {
    ...
    func imagePreviewer(_ imagePreviewer: CZImagePreviewer, accessoryViewForCellWith cellViewController: PreviewerCellViewController) -> CZImagePreviewer.AccessoryView?
...
public extension ImagePreviewerDataSource {
    ...
    func imagePreviewer(_ imagePreviewer: CZImagePreviewer, accessoryViewForCellWith cellViewController: PreviewerCellViewController) -> CZImagePreviewer.AccessoryView? { nil }
